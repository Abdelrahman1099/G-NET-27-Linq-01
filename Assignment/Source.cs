        ...
        public static List<Customer> CustomerList = new()
            {
                new Customer
                {
                    ...
                    Orders = new Order[]
                    {
                        new Order { OrderID = 1, OrderDate = new DateTime(1996, 5, 10), Total = 150m },
                        new Order { OrderID = 2, OrderDate = new DateTime(1997, 3, 22), Total = 200m },
                    }
                },
                new Customer
                {
                    ...
                    Orders = new Order[]
                    {
                        new Order { OrderID = 3, OrderDate = new DateTime(1996, 11, 30), Total = 80m },
                        new Order { OrderID = 4, OrderDate = new DateTime(1999, 1, 5),  Total = 500m },
                    }
                },
            };
